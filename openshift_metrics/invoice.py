...
class Pod:
    ...
    def get_runtime(
        self, ignore_times: List[Tuple[datetime.datetime, datetime.datetime]] | None = None
    ) -> Decimal:
...
class ProjectInvoce:
    ...
    rates: Rates
    su_definitions: dict
    ignore_hours: List[Tuple[datetime.datetime, datetime.datetime]] = field(default_factory=list)
    su_hours: dict = field(
